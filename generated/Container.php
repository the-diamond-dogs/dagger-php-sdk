...
class Container extends \DaggerIo\Client\AbstractDaggerObject implements \DaggerIo\Client\IdAble
{
	...
	{
		$innerQueryBuilder = new \DaggerIo\Client\DaggerQueryBuilder('defaultArgs');
	...
	{
		$innerQueryBuilder = new \DaggerIo\Client\DaggerQueryBuilder('entrypoint');
		return new \DaggerIo\Gen\array($this->client, $this->queryBuilderChain->chain($innerQueryBuilder));
	}
	...
	{
		$innerQueryBuilder = new \DaggerIo\Client\DaggerQueryBuilder('envVariables');
		return new \DaggerIo\Gen\array($this->client, $this->queryBuilderChain->chain($innerQueryBuilder));
	}
	...
	{
		$innerQueryBuilder = new \DaggerIo\Client\DaggerQueryBuilder('exposedPorts');
		return new \DaggerIo\Gen\array($this->client, $this->queryBuilderChain->chain($innerQueryBuilder));
	}
	...
	{
		$innerQueryBuilder = new \DaggerIo\Client\DaggerQueryBuilder('labels');
		return new \DaggerIo\Gen\array($this->client, $this->queryBuilderChain->chain($innerQueryBuilder));
	}
	...
	{
		$innerQueryBuilder = new \DaggerIo\Client\DaggerQueryBuilder('mounts');
		return new \DaggerIo\Gen\array($this->client, $this->queryBuilderChain->chain($innerQueryBuilder));
	}
	 ...
	 */
	public function withExposedPort(int $port, ?NetworkProtocol $protocol = null, ?string $description = null): Container
	{
	 ...
	 */
	public function withMountedDirectory(string $path, DirectoryId|Directory $source, ?string $owner = null): Container
	{
