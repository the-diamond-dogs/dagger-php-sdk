...
class TypeDef extends \DaggerIo\Client\AbstractDaggerObject implements \DaggerIo\Client\IdAble
{
	...
	{
		$innerQueryBuilder = new \DaggerIo\Client\DaggerQueryBuilder('kind');
		return new \DaggerIo\Gen\TypeDefKind($this->client, $this->queryBuilderChain->chain($innerQueryBuilder));
	}
